...
def main(argv):
    ...
    parser.add_argument(
        "--config_file",
        default="/home/shanhai/mycode/myATISS-master/config/bedrooms_config.yaml",
        help="Path to the file that contains the experiment configuration"
    )
    parser.add_argument(
        "--output_directory",
        default="/home/shanhai/outputs",
        help="Path to the output directory"
    )
    parser.add_argument(
        "--path_to_pickled_3d_futute_models",
        default="/home/shanhai/outputs/atiss/threed_future_model_bedroom.pkl",
    ...
    parser.add_argument(
        "--weight_file",
        default="/home/shanhai/outputs/atiss/trained_models/68EFYUEVX/model_01950",
